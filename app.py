    ...
    if analiz_turu == "Periyot":
        ...
        with st.spinner('Mum grafiği için veriler yükleniyor...'):
            ...
            if ohlc_df is not None and not ohlc_df.empty:
                ...
                fig.update_layout(xaxis_rangeslider_visible=False, yaxis_title="Fiyat (USD)", xaxis_title="Tarih", template="plotly_dark", height=500, margin=dict(l=20, r=20, t=20, b=20), legend=dict(yanchor="top", y=0.99, xanchor="left", x=0.01))
